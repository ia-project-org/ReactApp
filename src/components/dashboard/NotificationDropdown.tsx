...
import { X, CheckCircle, AlertCircle, Clock, Bell } from 'lucide-react';
...
export const NotificationDropdown: React.FC<NotificationDropdownProps> = ({ notifications, onClose }) => {
    ...
    const getStatusDetails = (jobState: string) => {
        return statusMap[jobState.toUpperCase()] || statusMap['DEFAULT'];
    };
